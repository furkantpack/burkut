    ...
    <div className='bg-bg-white-0 py-10 lg:py-24 w-full'>
      <div className='relative mx-auto flex max-w-[1016px] flex-col'>
        ...
        <div className='relative z-2 mb-8 flex flex-col px-6 lg:mb-10 lg:items-center lg:px-0'>
          ...
          >
            Burkut Global contact
          </Badge.Root>
          <h3 className='text-title-h4 lg:text-title-h3 text-text-strong-950 mb-4 !font-normal'>
            Let&apos;s build strategic advantage together
          </h3>
          <p className='text-paragraph-md text-text-sub-600 max-w-2xl lg:text-center'>
            Connect with BURKUT GLOBAL Holding for defense technologies,
            infrastructure, advanced materials, and international engineering
            partnerships.
          </p>
        </div>
        <div className='relative z-2 flex flex-col items-center px-2 lg:px-0'>
          ...
          >
            ...
            <div className='my-2 flex items-center gap-3'>
              <Checkbox.Root id={`${uniqueId}-c1`} className='size-5' defaultChecked />
              <Label.Root
          ...
          <div className='text-label-sm text-text-soft-400 w-full text-center lg:w-101'>
            ...
            <span className='text-text-sub-600 text-label-sm'>
              shaping resilient solutions for tomorrow.
            </span>
          </div>
        </div>
      </div>
